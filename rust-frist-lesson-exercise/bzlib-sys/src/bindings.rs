...
fn bindgen_test_layout_bz_stream() {
    ...
    fn test_field_next_in() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<bz_stream>::uninit();
    ...
    test_field_avail_in();
    fn test_field_total_in_lo32() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<bz_stream>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).total_in_lo32) as usize - ptr as usize
            },
            12usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_total_in_lo32();
    fn test_field_total_in_hi32() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<bz_stream>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).total_in_hi32) as usize - ptr as usize
            },
            16usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_total_out_lo32() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<bz_stream>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).total_out_lo32) as usize - ptr as usize
            },
            36usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_total_out_lo32();
    fn test_field_total_out_hi32() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<bz_stream>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).total_out_hi32) as usize - ptr as usize
            },
            40usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_state();
    fn test_field_bzalloc() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<bz_stream>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).bzalloc) as usize - ptr as usize
            },
            56usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_bzalloc();
    fn test_field_bzfree() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<bz_stream>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).bzfree) as usize - ptr as usize
            },
            64usize,
            concat!(
                "Offset of field: ",
